...
export const Logo: React.FC = () => (
  <Box className={clsx(special.logoContainer, display.logoContainer)}>
    ...
    <Link
      to="/dashboard"
      className={clsx(
        mbp.logoGraphicContainer,
        display.logoGraphicContainer,
        size.logoGraphicContainer,
      )}
    >
      <img
        src={logoImage}
        alt="Logo"
        className={clsx(special.logoGraphic, size.logoGraphic)}
      />
    </Link>
    <Link
      to="/dashboard"
      className={clsx(special.logoText, size.logoText, text.logoText)}
    >
      Maestro
    </Link>
  </Box>
